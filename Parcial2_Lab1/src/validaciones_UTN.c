...
int validacionStringAlphaConEspacios(char string[], char mensaje[],int cantidadArray)
{
...
int validacionStringAlphaSinEspacios(char string[], char mensaje[],int cantidadArray)
{
	char auxiliar[cantidadArray];
	int retorno = -1;
	int longitud;
